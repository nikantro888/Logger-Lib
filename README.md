...
### <a name='event_bus_key'>Event key</a>
 - First of all, we need to create specific keys to send and observe events. 
 - Store event bys keys in api modules: SpaceExample-Api -> events.
  ```kotlin
